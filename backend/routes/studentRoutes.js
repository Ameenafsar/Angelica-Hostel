...
router.post('/register-student', [
    ...
    check('admission_no', 'ADMISSION ID of at least 6 digit is required').isLength(6),
    ...
    check('aadhar_card', 'Enter valid AADHAR').isLength(12),
...
router.post('/update-student', [
    check('admission_no', 'ADMISSION ID is required').not().isEmpty(),
